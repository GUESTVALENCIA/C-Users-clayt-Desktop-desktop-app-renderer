...
try:
    ...
    if os.path.exists(env_path):
        ...
        print("[OK] Variables cargadas desde: " + env_path)
    else:
...
# Obtener DATABASE_URL - URL real de NEON
DATABASE_URL = os.getenv('DATABASE_URL')
if not DATABASE_URL:
    # URL directa de NEON desde VARIABLESFULL.txt
    # Usar la URL genérica para evitar problemas de credenciales
    ...
    print("[WARN] DATABASE_URL no encontrado en .env, usando URL directa de NEON")
...
def get_neon_conn():
    ...
    try:
        ...
        # Intentar con una conexión de solo lectura o alternativa si falla
        raise
...
class MCPHandler(BaseHTTPRequestHandler):
    ...
    def handle_tool(self, server, tool, args):
        ...
        # Memoria de la Reina (NEON) - con manejo de errores
    ...
    def handle_reina_memory(self, tool, args):
        ...
        try:
            ...
            print("[ERROR] Error de conexión a la base de datos: " + str(e))
            return {"error": "Error de conexión a la base de datos. Usando modo offline."}
        except Exception as e:
